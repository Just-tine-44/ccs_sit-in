...
<head>
    ...
    <title>Lab Usage Points | Admin</title>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <select id="student_id" name="student_id" class="focus:ring-green-500 focus:border-green-500 block w-full pl-10 pr-3 py-3 sm:text-sm border-gray-300 rounded-lg appearance-none" required>
                                    ...
                                    <?php foreach ($students as $student): ?>
                                        <?php if ($student['current_sessions'] < 30): ?>
                                            <option value="<?php echo $student['id']; ?>" data-sessions="<?php echo $student['current_sessions']; ?>">
                                                <?php echo htmlspecialchars($student['name']); ?> (<?php echo htmlspecialchars($student['idno']); ?>) - <?php echo htmlspecialchars($student['course']); ?>
                                            </option>
                                        <?php else: ?>
                                            <option value="<?php echo $student['id']; ?>" data-sessions="<?php echo $student['current_sessions']; ?>" disabled class="text-gray-400">
                                                <?php echo htmlspecialchars($student['name']); ?> (Max Sessions: 30/30)
                                            </option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php foreach ($students as $student): ?>
                                <tr class="hover:bg-gray-50 transition-colors student-row" 
                                    ...
                                    data-id="<?php echo strtolower(htmlspecialchars($student['idno'])); ?>"
                                    data-points="<?php echo $student['current_points']; ?>"
                                    data-sessions="<?php echo $student['current_sessions']; ?>">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="mb-1 flex justify-between items-center">
                                            <span class="text-xs font-medium text-gray-700">
                                                <?php echo $student['current_points']; ?>/3 Points
                                            </span>
                                            <?php if ($student['current_points'] == 3): ?>
                                        ...
                                        <div class="points-progress h-2 relative max-w-xl rounded-full overflow-hidden bg-gray-200">
                                            <?php 
                                                $percentage = ($student['current_points'] / 3) * 100;
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        $sessionClass = ($student['current_sessions'] >= 30) ? 'text-red-600 font-medium' : 'text-gray-900';
                                        ?>
                                        <div class="text-sm <?php echo $sessionClass; ?> flex items-center justify-center">
                                            <i class="far fa-clock mr-1 <?php echo ($student['current_sessions'] >= 30) ? 'text-red-500' : 'text-gray-400'; ?>"></i>
                                            <?php echo $student['current_sessions']; ?>/30
                                            <?php if ($student['current_sessions'] >= 30): ?>
